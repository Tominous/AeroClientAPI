...
public class APIHelpCommand implements CommandExecutor {
  public boolean onCommand(CommandSender sender, Command cmd, String s, String[] args) {
    ...
    p.sendMessage(ChatColor.BLUE + "/aacinfo: " + ChatColor.GREEN + "Show info about the AeroClientAPI.");
    p.sendMessage(ChatColor.BLUE + "/aachelp: " + ChatColor.GREEN + "Show AeroClientAPI help.");
    p.sendMessage(ChatColor.BLUE + "/aacreload: " + ChatColor.GREEN + "Reload the config");
